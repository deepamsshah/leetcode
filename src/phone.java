    ...
    public static void validatePhone(String phoneNumber){
        ...
        if (matcher.matches()){
            if(phoneNumber.charAt(0)=='0'||phoneNumber.charAt(0)=='1'){
                ...
                char first = phoneNumber.charAt(1);
                char second = phoneNumber.charAt(2);
                char third = phoneNumber.charAt(3);
                String areaCode = ""+first+second+third;
                boolean test = Arrays.asList(areaCodes).contains(areaCode);
                if(test){
                ...
                char second = phoneNumber.charAt(1);
